...
public class ValidacaoHelper {
	...
	/**
	 * Valida uma Regia de  Cep.
	 * @param cep.Regiao
	 *            valor a ser validado sera a regiao do cep, podendo ter somente 5 digitos. 
	 * @return void
	 */
	public static void validatorRegiao(String regiao){
	    if(regiao != null){
	...
	/**
	 * Valida um Sufixo de  Cep.
	 * @param cep.Sufixo
	 *            valor a ser validado sera o sufixo do cep, podendo ter somente 3 digitos. 
	 * @return void
	 */
	public static void validatorSufixo(String sufixo) {
		  if(sufixo != null){
